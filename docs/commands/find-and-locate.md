...
- findutils（GNU find）手册 — [gnu.org](https://www.gnu.org/software/findutils/manual/)
- grep 手册 — [gnu.org](https://www.gnu.org/software/grep/manual/)
- gawk 手册（GNU awk） — [gnu.org](https://www.gnu.org/software/gawk/manual/)
- sed 手册 — [gnu.org](https://www.gnu.org/software/sed/manual/)
