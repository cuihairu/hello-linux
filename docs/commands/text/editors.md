...
- [man vim (Arch)](https://man.archlinux.org/man/vim.1.en) / [man nano](https://man.archlinux.org/man/nano.1.en) / [man less](https://man.archlinux.org/man/less.1.en) / [man more](https://man.archlinux.org/man/more.1.en) / [man cat](https://man.archlinux.org/man/cat.1.en) / [man head](https://man.archlinux.org/man/head.1.en) / [man tail](https://man.archlinux.org/man/tail.1.en)
- [Vim 手册](https://www.vim.org/docs.php) · [Vim 快捷键cheatsheet](https://vim.rtorr.com/)
- [Arch Wiki - Vim](https://wiki.archlinux.org/title/Vim) · [Arch Wiki - Neovim](https://wiki.archlinux.org/title/Neovim) · [Arch Wiki - Pacman](https://wiki.archlinux.org/title/Pacman) · [Arch Wiki - Base meta package](https://wiki.archlinux.org/title/Base_meta_package)
- [Nano 官方文档](https://www.nano-editor.org/docs.php)
- [archlinux.org: vim](https://archlinux.org/packages/extra/x86_64/vim/) · [neovim](https://archlinux.org/packages/extra/x86_64/neovim/) · [ex-vi-compat](https://archlinux.org/packages/extra/x86_64/ex-vi-compat/)
