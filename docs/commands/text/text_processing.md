...
- man grep — [man.archlinux.org](https://man.archlinux.org/man/grep.1.en)
- man sed — [man.archlinux.org](https://man.archlinux.org/man/sed.1.en)
- man awk — [man.archlinux.org](https://man.archlinux.org/man/awk.1.en)
- man sort — [man.archlinux.org](https://man.archlinux.org/man/sort.1.en)
- man uniq — [man.archlinux.org](https://man.archlinux.org/man/uniq.1.en)
- man tr — [man.archlinux.org](https://man.archlinux.org/man/tr.1.en)
- man cut — [man.archlinux.org](https://man.archlinux.org/man/cut.1.en)
- man wc — [man.archlinux.org](https://man.archlinux.org/man/wc.1.en)
- man xargs — [man.archlinux.org](https://man.archlinux.org/man/xargs.1.en)
- man tee — [man.archlinux.org](https://man.archlinux.org/man/tee.1.en)
