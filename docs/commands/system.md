...
- Arch Wiki - Btop/Htop（监控工具） — [wiki.archlinux.org](https://wiki.archlinux.org/title/Improving_performance)
- procps-ng 项目页 — [gitlab.com](https://gitlab.com/procps-ng/procps)
- sysstat 手册（iostat/vmstat/sar） — [sebastien.godard.pagesperso-orange.fr](https://github.com/sysstat/sysstat)
