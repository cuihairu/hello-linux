...
- [鸟哥的私房菜 - 软件包管理](https://linux.vbird.org/linux_basic/0510source_manager.php)
- [Arch Wiki - pacman](https://wiki.archlinux.org/title/Pacman)
- [Arch Wiki - AUR](https://wiki.archlinux.org/title/Arch_User_Repository)
- [Debian Wiki - apt](https://wiki.debian.org/Apt)
- [Ubuntu - PPA / repositories 文档](https://documentation.ubuntu.com/ubuntu/howto/manageing-software/)
- [DNF 文档（Fedora）](https://dnf.readthedocs.io/)
- [Red Hat - Installing software packages with DNF](https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/9/html/installing_managing_software_with_the_dnf_tool/index)
- [EPEL FAQ](https://docs.fedoraproject.org/en-US/epel/faq)
