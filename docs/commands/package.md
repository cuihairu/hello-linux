...
- 鸟哥的私房菜 - 软件管理（RPM/DPKG/YUM） — [linux.vbird.org](https://linux.vbird.org/linux_basic/centos7/0520rpm_and_srpm.php)
...
- Rocky Linux 文档 - 软件管理 — [docs.rockylinux.org](https://docs.rockylinux.org/)
