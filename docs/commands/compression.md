...
- Arch Wiki - Pacman（`.pkg.tar.zst` 包格式） — [wiki.archlinux.org](https://wiki.archlinux.org/title/Pacman)
- Arch Wiki - zstd — [wiki.archlinux.org](https://wiki.archlinux.org/title/Zstd)
- 鸟哥的私房菜 - 压缩与打包指令 — [linux.vbird.org](https://linux.vbird.org/linux_basic/centos7/0240tar.php)
