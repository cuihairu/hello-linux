...
| cpu | `us sy id wa st` | 用户/系统/空闲/IO 等待/虚拟机被偷；`st` 高 = 宿主机超卖 |
...
- 鸟哥的私房菜 - 物理内存与虚拟内存 — [linux.vbird.org](https://linux.vbird.org/linux_basic/centos7/0610hardware.php)
- Arch Wiki - Memory（含 OOM 与 swap 语义） — [wiki.archlinux.org](https://wiki.archlinux.org/title/Improving_performance)
- Arch Wiki - Btrfs swapfile 注意事项 — [wiki.archlinux.org](https://wiki.archlinux.org/title/Btrfs#Swap_file)
- Arch Wiki - NUMA — [wiki.archlinux.org](https://wiki.archlinux.org/title/Improving_performance)
- JEDEC DDR4 Standard — [jedec.org](https://www.jedec.org/standards-documents)
...
- Linux Kernel Documentation - OOM Killer — [kernel.org](https://www.kernel.org/doc/html/latest/admin-guide/mm/concepts.html)
