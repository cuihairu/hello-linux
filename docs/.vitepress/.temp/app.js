...
const siteData = deserializeFunctions(JSON.parse('{"lang":"zh-CN","dir":"ltr","title":"Hello Linux","description":"从零开始学习 Linux","base":"/hello-linux/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"logo":"/logo.svg","siteTitle":"Hello Linux","nav":[{"text":"首页","link":"/"},{"text":"基础篇","link":"/basic/overview"},{"text":"命令篇","link":"/commands/basic/file"},{"text":"硬件篇","link":"/hardware/architecture"},{"text":"服务器篇","link":"/server/web/nginx"},{"text":"系统管理","link":"/system-management/performance"},{"text":"网络篇","link":"/network/basics"}],"sidebar":{"/basic/":[{"text":"基础篇","items":[{"text":"概述","link":"/basic/overview"},{"text":"技术概论","link":"/basic/overview"},{"text":"Linux 简介","collapsed":false,"items":[{"text":"什么是 Linux","link":"/basic/introduction/what_is_linux"},{"text":"Linux 的历史","link":"/basic/introduction/history"},{"text":"发行版简介","link":"/basic/introduction/distributions"}]},{"text":"安装 Linux","collapsed":false,"items":[{"text":"选择发行版","link":"/basic/installation/choose_distribution"},{"text":"安装前准备","link":"/basic/installation/preparation"},{"text":"安装过程","link":"/basic/installation/process"}]},{"text":"文件系统","collapsed":false,"items":[{"text":"文件系统概念","link":"/basic/filesystem/concept"},{"text":"目录层次结构","link":"/basic/filesystem/hierarchy"},{"text":"文件权限","link":"/basic/filesystem/permissions"}]},{"text":"开机流程","collapsed":false,"items":[{"text":"BIOS 与 UEFI","link":"/basic/boot/bios_uefi"},{"text":"GRUB 引导程序","link":"/basic/boot/grub"}]},{"text":"软件安装","collapsed":false,"items":[{"text":"APT 包管理","link":"/basic/packages/apt"},{"text":"YUM/DNF 包管理","link":"/basic/packages/yum"}]},{"text":"用户管理","collapsed":false,"items":[{"text":"账号管理","link":"/basic/users/account_management"},{"text":"ACL 权限控制","link":"/basic/users/acl_permissions"},{"text":"磁盘配额","link":"/basic/users/disk_quotas"}]},{"text":"系统服务","collapsed":false,"items":[{"text":"系统服务管理","link":"/basic/services/system_services"},{"text":"日志管理","link":"/basic/services/log_management"},{"text":"系统配置工具","link":"/basic/services/configuration_tools"}]},{"text":"安全基础","collapsed":false,"items":[{"text":"SELinux 概念","link":"/basic/security/concept"},{"text":"SELinux 模式","link":"/basic/security/modes"},{"text":"SELinux 命令","link":"/basic/security/commands"},{"text":"SELinux 策略","link":"/basic/security/policy_configuration"}]},{"text":"日志系统","collapsed":false,"items":[{"text":"系统日志","link":"/basic/log/syslog"},{"text":"日志轮转","link":"/basic/log/rotation"}]}]}],"/commands/":[{"text":"命令篇","items":[{"text":"概述","link":"/commands/basic/file"},{"text":"基本命令","collapsed":false,"items":[{"text":"文件操作","link":"/commands/basic/file"},{"text":"目录操作","link":"/commands/basic/directory"}]},{"text":"文本处理","collapsed":false,"items":[{"text":"文本处理命令","link":"/commands/text/text_processing"}]},{"text":"系统管理","collapsed":false,"items":[{"text":"系统信息查看","link":"/commands/system/system_info"},{"text":"进程管理","link":"/commands/system/process"},{"text":"内存管理","link":"/commands/system/memory"}]},{"text":"网络管理","collapsed":false,"items":[{"text":"网络命令","link":"/commands/network/network"}]},{"text":"包管理","collapsed":false,"items":[{"text":"包管理命令","link":"/commands/package/package"}]}]}],"/hardware/":[{"text":"硬件篇","items":[{"text":"概述","link":"/hardware/architecture"},{"text":"计算机体系结构","link":"/hardware/architecture"},{"text":"CPU","link":"/hardware/cpu"},{"text":"内存","link":"/hardware/memory"},{"text":"存储设备","link":"/hardware/storage"},{"text":"网络设备","link":"/hardware/network"}]}],"/system-management/":[{"text":"系统管理篇","items":[{"text":"概述","link":"/system-management/performance"},{"text":"性能优化","link":"/system-management/performance"}]}],"/network/":[{"text":"网络篇","items":[{"text":"概述","link":"/network/basics"},{"text":"网络基础","link":"/network/basics"},{"text":"防火墙","link":"/network/firewall"}]}],"/server/":[{"text":"服务器篇","items":[{"text":"概述","link":"/server/web/nginx"},{"text":"Web 服务器","collapsed":false,"items":[{"text":"Nginx","link":"/server/web/nginx"}]},{"text":"数据库","collapsed":false,"items":[{"text":"MySQL","link":"/server/database/mysql"}]},{"text":"容器","collapsed":false,"items":[{"text":"Docker","link":"/server/container/docker"}]},{"text":"监控","collapsed":false,"items":[{"text":"Prometheus + Grafana","link":"/server/monitoring/prometheus"}]},{"text":"DNS","collapsed":false,"items":[{"text":"BIND","link":"/server/dns/bind"}]},{"text":"邮件","collapsed":false,"items":[{"text":"Postfix","link":"/server/mail/postfix"}]}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/cuihairu/hello-linux"}],"search":{"provider":"local","options":{"translations":{"button":{"buttonText":"搜索文档"},"modal":{"noResultsText":"没有找到结果","resetButtonTitle":"清除查询","footer":{"selectText":"选择","navigateText":"切换","closeText":"关闭"}}}}},"outline":{"level":[2,3],"label":"页面导航"},"lastUpdated":{"text":"最后更新"},"docFooter":{"prev":"上一篇","next":"下一篇"},"editLink":{"pattern":"https://github.com/cuihairu/hello-linux/edit/main/docs/:path","text":"在 GitHub 上编辑此页面"},"footer":{"message":"基于 Apache License 2.0 许可发布","copyright":"© 2024 Hello Linux"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.D1oYAPMJ.js"));
